...
export const fetchSadqaMemberData = async () => {
  ...
  // addSadqaMemberData
  export const addSadqaMemberData = async (modalData: any) => {
  ...
  export const updateSadqaMemberData = async (updatedMemeber: any) => {
    // const token = localStorage.getItem("token");
    // if (!token) {
    //   throw new Error("No authentication token found");
    // }
  ...
  // new
  export const addSadqaPaymentData = async (paymentData: any) => {
    // const token = localStorage.getItem("token");
    // if (!token) {
    //   throw new Error("No authentication token found");
    // }
  ...
  export const updateSadqaPaymentData = async (paymentData: any) => {
